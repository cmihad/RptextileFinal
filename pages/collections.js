...
<div className="absolute centerd">
    ...
    <h1 className=" 
    text-white font-montserrat text-2xl uppercase font-bold text-center">
              Sweater
          </h1>
          <Link href="/sweater">
        ...
        <div class="my-1 px-1 w-full lg:my-4 lg:px-4 ">
            ...
            <article class="overflow-hidden rounded-lg shadow-lg relative">
              ...
              see more
                ...
                <a href="#">
                    <img alt="Placeholder" class="block h-auto w-full" src="https://images.unsplash.com/photo-1549037173-e3b717902c57?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80"/>
                </a>
